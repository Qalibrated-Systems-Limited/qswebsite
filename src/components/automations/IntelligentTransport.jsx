...
const IntelligentTransportSystemsPage = () => {
  const [activeNavItem, setActiveNavItem] = useState('/automation/intelligent-transport');
    ...
    <div className="min-h-screen bg-gray-100 font-sans text-gray-800">
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-2">Intelligent Transport Systems</h1>
          <p className="text-lg md:text-xl">Home / Automation / <span className="text-amber-400">Intelligent Transport Systems</span></p>
        </div>
      </section>
      ...
      <main className="container mx-auto px-4 py-12 flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-3/4 bg-white rounded-lg shadow-md p-8">
          ...
          {/* <img 
            src={IndustrialAutomation} // Image from PPT Page 10 or 11
            alt="Intelligent Transport Systems" 
          ...
          <p className="text-gray-700 leading-relaxed mb-6">
            Intelligent Transport Systems (ITS) leverage advanced technologies to improve transport efficiency, safety, and sustainability. This includes systems for traffic management, electronic cargo tracking, and real-time monitoring of vehicles and goods.
          </p>
          <p className="text-gray-700 leading-relaxed mb-8">
            Our solutions, such as the Electronic Cargo Tracking System (ECTS) and High Speed Weighing in Motion (HSWIM), provide real-time data for enforcement, reduce road damage from overloading, and enhance supply chain security.
          </p>
          <h2 className="text-3xl font-bold text-gray-800 mb-4">KEY COMPONENTS & BENEFITS</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-700">
            <div className="flex items-start">
              <span className="text-amber-500 mr-2 text-xl">&raquo;</span>
              <p>eLock: Intelligent tracking and positioning lock for securing logistics and freight assets (key-less, RFID/remote unlocking, real-time monitoring, illegal unlocking alarms).</p>
            </div>
            <div className="flex items-start">
              <span className="text-amber-500 mr-2 text-xl">&raquo;</span>
              <p>SAGLOBAL Platform: Complete SaaS platform supporting various tracker types, fleet management, ECTS, fuel monitoring, and flexible UI configurations.</p>
            </div>
            <div className="flex items-start">
              <span className="text-amber-500 mr-2 text-xl">&raquo;</span>
              <p>Real-Time Tracking: Monitor status of electronic seals, detect route deviations, track goods and trucks to destination.</p>
            </div>
            <div className="flex items-start">
              <span className="text-amber-500 mr-2 text-xl">&raquo;</span>
              <p>Revenue Maximization: Anti-dumping/diversion, faster goods movement, elimination of non-tariff barriers, reduced corruption.</p>
            </div>
            <div className="flex items-start">
              <span className="text-amber-500 mr-2 text-xl">&raquo;</span>
              <p>Increased Security: Enhanced security of monitored goods and conveyances.</p>
            </div>
            <div className="flex items-start">
              <span className="text-amber-500 mr-2 text-xl">&raquo;</span>
              <p>Improved Compliance: Promotes voluntary compliance and identifies compliant stakeholders.</p>
            </div>
          </div>
        </div>
      </main>
...
export default IntelligentTransportSystemsPage;
