...
const OnboardWeighingPage = () => {
  const [activeNavItem, setActiveNavItem] = useState('/weighing/onboard-weighing');
  ...
  return (
    <div className="min-h-screen bg-gray-100 font-sans text-gray-800">
      ...
      <section 
        ...
        style={{ 
          backgroundImage: "url('/weighing.png')", // Placeholder image for onboard weighing
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-2">Onboard Weighing</h1>
          <p className="text-lg md:text-xl">Home / Weighing / <span className="text-amber-400">Onboard Weighing</span></p>
        </div>
      </section>
      ...
      <main className="container mx-auto px-4 py-12 flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-3/4 bg-white rounded-lg shadow-md p-8">
          ...
          {/* <img 
            src={RetailScale} // Placeholder image for onboard weighing" // Placeholder image for onboard weighing
            alt="Onboard Weighing" 
            className="w-full h-1/2 rounded-lg mb-8"
          /> */}

          {/* Description Section */}
          <h2 className="text-3xl font-bold text-gray-800 mb-4">DESCRIPTION</h2>
          <p className="text-gray-700 leading-relaxed mb-6">
            Onboard weighing systems allow vehicles to be weighed directly on the truck or trailer, providing real-time load data. This is crucial for preventing overloading, optimizing payload, and ensuring compliance with road regulations before the vehicle leaves the site.
          </p>
          <p className="text-gray-700 leading-relaxed mb-8">
            These systems are particularly beneficial for industries like logistics, waste management, and construction, where precise load management directly impacts operational efficiency and legal compliance.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-700">
            <div className="flex items-start">
              ...
              <p>Real-time weight display in the cabin</p>
            </div>
            <div className="flex items-start">
              <span className="text-amber-500 mr-2 text-xl">&raquo;</span>
              <p>Prevents overloading and underloading</p>
            </div>
            <div className="flex items-start">
              <span className="text-amber-500 mr-2 text-xl">&raquo;</span>
              <p>Optimizes payload and reduces trips</p>
            </div>
            <div className="flex items-start">
              <span className="text-amber-500 mr-2 text-xl">&raquo;</span>
              <p>Ensures compliance with road legal limits</p>
            </div>
            <div className="flex items-start">
              <span className="text-amber-500 mr-2 text-xl">&raquo;</span>
              <p>Easy installation and robust design</p>
            </div>
            <div className="flex items-start">
              <span className="text-amber-500 mr-2 text-xl">&raquo;</span>
...
export default OnboardWeighingPage;
