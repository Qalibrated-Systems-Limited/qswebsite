...
const RetailScalesPage = () => {
  const [activeNavItem, setActiveNavItem] = useState('/weighing/retail-scales');
    ...
    <div className="min-h-screen bg-gray-100 font-sans text-gray-800">
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-2">Retail Scales</h1>
          <p className="text-lg md:text-xl">Home / Weighing / <span className="text-amber-400">Retail Scales</span></p>
        </div>
      </section>
      ...
      <main className="container mx-auto px-4 py-12 flex flex-col lg:flex-row gap-8">
        ...
        {/* Right Content Area */}
        <div className="w-full h-1/2 bg-white rounded-lg shadow-md p-8">
          ...
          <p className="text-gray-700 leading-relaxed mb-6">
            Retail scales are essential tools for businesses in the food, grocery, and other retail sectors, providing accurate and fast weighing of products for sale. These scales are designed for user-friendliness, durability, and compliance with commercial weighing regulations.
          </p>
          <p className="text-gray-700 leading-relaxed mb-8">
            Our range of retail scales includes models with various capacities and features, suitable for different business needs, from simple price computing to advanced POS integration.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-700">
            <div className="flex items-start">
              ...
              <p>High accuracy for precise pricing</p>
            </div>
            <div className="flex items-start">
              <span className="text-amber-500 mr-2 text-xl">&raquo;</span>
              <p>Durable and easy-to-clean surfaces</p>
            </div>
            <div className="flex items-start">
              <span className="text-amber-500 mr-2 text-xl">&raquo;</span>
              <p>Clear digital displays for both customer and operator</p>
            </div>
            <div className="flex items-start">
              <span className="text-amber-500 mr-2 text-xl">&raquo;</span>
              <p>Legal-for-trade certification</p>
            </div>
            <div className="flex items-start">
              <span className="text-amber-500 mr-2 text-xl">&raquo;</span>
              <p>Fast and stable weighing performance</p>
            </div>
            <div className="flex items-start">
              <span className="text-amber-500 mr-2 text-xl">&raquo;</span>
              <p>Optional connectivity for POS systems and printers</p>
            </div>
          </div>
        </div>
      </main>
